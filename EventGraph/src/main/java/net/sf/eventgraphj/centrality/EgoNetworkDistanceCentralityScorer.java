 ...
 */
package net.sf.eventgraphj.centrality;
 ...
 */
public class EgoNetworkDistanceCentralityScorer<V,E> implements VertexScorer<V, Double>
{
    /**
    ...
    protected double egoNetworkSize = 1;
     ...
     */
    public EgoNetworkDistanceCentralityScorer(Hypergraph<V,E> graph, Distance<V> distance, 
    		double egoNetworkSize,
    		boolean averaging, boolean ignore_missing, 
    		boolean ignore_self_distances)
    {
        this.graph = graph;
        this.distance = distance;
        this.egoNetworkSize = egoNetworkSize;
    ...
    public EgoNetworkDistanceCentralityScorer(Hypergraph<V,E> graph, Distance<V> distance, 
    		...
    		boolean averaging)
    {
    	this(graph, distance, egoNetworkSize,averaging, true, true);
    }
     ...
     * to itself should be included in its score.
     */
    public EgoNetworkDistanceCentralityScorer(Hypergraph<V,E> graph, 
            Transformer<E, ? extends Number> edge_weights, double egoNetworkSize,
            boolean averaging,
            boolean ignore_missing, boolean ignore_self_distances)
    {
        this(graph, new DijkstraDistance<V,E>(graph, edge_weights), egoNetworkSize,
        		averaging,
     ...
     */
    public EgoNetworkDistanceCentralityScorer(Hypergraph<V,E> graph, 
            Transformer<E, ? extends Number> edge_weights, double egoNetworkSize, boolean averaging)
    {
        this(graph, new DijkstraDistance<V,E>(graph, edge_weights), egoNetworkSize,averaging,
        	true, true);
    }
     ...
     * to itself should be included in its score.
     */
    public EgoNetworkDistanceCentralityScorer(Hypergraph<V,E> graph, double egoNetworkSize,boolean averaging,
            boolean ignore_missing, boolean ignore_self_distances)
    {
        this(graph, new UnweightedShortestPath<V,E>(graph), egoNetworkSize, averaging, 
        	ignore_missing, ignore_self_distances);
    }
    ...
    public EgoNetworkDistanceCentralityScorer(Hypergraph<V,E> graph, double egoNetworkSize, boolean averaging)
    {
        this(graph, new UnweightedShortestPath<V,E>(graph), egoNetworkSize,averaging, true, true);
    }
