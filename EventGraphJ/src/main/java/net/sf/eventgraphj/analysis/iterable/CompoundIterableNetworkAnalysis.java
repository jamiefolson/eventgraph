...
public class CompoundIterableNetworkAnalysis<K extends Comparable<K>, V, E> extends
	...
	List<NetworkAnalysis<V, EdgeEntry<K, V, E>, Graph<V, EdgeEntry<K, V, E>>, ?>> analyses;
	...
	public CompoundIterableNetworkAnalysis(Iterable<Interval<K>> iterator) {
		super(iterator);
		analyses = new ArrayList<NetworkAnalysis<V, EdgeEntry<K, V, E>, Graph<V, EdgeEntry<K, V, E>>, ?>>();
	...
	protected Object doSubAnalysis(NavigableGraph<K, V, E> graph, K start, K stop) {
		for (NetworkAnalysis<V, EdgeEntry<K, V, E>, Graph<V, EdgeEntry<K, V, E>>, ?> analysis : analyses) {
	...
	public void addAnalysis(NetworkAnalysis<V, EdgeEntry<K, V, E>, Graph<V, EdgeEntry<K, V, E>>, ?> analysis) {
