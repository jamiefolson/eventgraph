 ...
 * Beta prior with alpha = {@code prior * priorStrength}, beta =
 * {@code (1-prior)*priorStrength}. Although this makes things awkward from a
...
public class PoissonNetworkInformation<K extends Number & Comparable<K>, V, E> extends
        DyadicComparison<V, EdgeEntry<K, V, E>, NavigableGraph<K, V, E>> implements
        NetworkComparison<V, EdgeEntry<K, V, E>, NavigableGraph<K, V, E>> {
	double scaling = 1;
	final double prior;
