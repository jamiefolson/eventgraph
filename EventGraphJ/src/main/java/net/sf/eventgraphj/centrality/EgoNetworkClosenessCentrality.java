 ...
 */
public class EgoNetworkClosenessCentrality<V,E> extends DistanceCentralityScorer<V,E>
{
     ...
     */
    public EgoNetworkClosenessCentrality(Hypergraph<V,E> graph, Distance<V> distance)
    {
     ...
     */
    public EgoNetworkClosenessCentrality(Hypergraph<V,E> graph, Transformer<E, ? extends Number> edge_weights)
    {
     ...
     * @param graph
     */
    public EgoNetworkClosenessCentrality(Hypergraph<V,E> graph)
    {
        super(graph, true);
    }
}
