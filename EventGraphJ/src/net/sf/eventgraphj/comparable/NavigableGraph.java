 ...
 *            the edge type
 */
public interface NavigableGraph<K extends Comparable<K>, V, E> extends Graph<V, EdgeEntry<K, E>>,
        Hypergraph<V, EdgeEntry<K, E>> {
